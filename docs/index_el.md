...
| Ταχύτητα αναπαραγωγής κάτω ανά 0.1     | [ ή / (Shift για cents) |
| Ταχύτητα αναπαραγωγής πάνω ανά 0.1     | ] ή * (Shift για cents) |
| Τονικότητα αναπαραγωγής ημιτόνιο κάτω  | - ή _ (Shift για cents) |
| Τονικότητα αναπαραγωγής ημιτόνιο πάνω  | = ή + (Shift για cents) |
