...
- Στο υπο-μενού **Βίντεο οπτικοποίησης** μπορούμε να δημιουργήσουμε ένα βίντεο με το τρέχον επιλεγμένο κομμάτι ήχου (όχι κομμάτι YouTube), συγχρονισμένο με τα στοιχεία οπτικοποίησης. Αυτό το υπο-μενού περιέχει τις ακόλουθες επιλογές:  
