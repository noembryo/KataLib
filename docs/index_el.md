...
* **Φασματογράφος**  
  Αυτό δείχνει επίσης το φάσμα συχνοτήτων του τρέχοντος αναπαραγόμενου κομματιού, αλλά περιέχει επίσης και τον άξονα του χρόνου.  
...
- Το μενού **Στοιχεία οπτικοποίησης**, μας επιτρέπει να επιλέξουμε ποια από τα στοιχεία οπτικοποίησης θέλουμε να εμφανίσουμε στο βίντεο.  
  Έχουμε την επιλογή να επιλέξουμε/αποεπιλέξουμε οποιοδήποτε από τα στοιχεία ή την κυματομορφή.
...
- Το μενού **Γραμμές αναλυτή φάσματος**, μας επιτρέπει να επιλέξουμε τον αριθμό των γραμμών που θα χρησιμοποιηθούν από τον αναλυτή φάσματος.  
  Η προεπιλογή είναι 32, αλλά μπορούμε να επιλέξουμε μια τιμή μεταξύ 24, 32, 40, 48 και 56.
